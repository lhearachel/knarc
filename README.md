...
# Usage
```
Usage: knarc [--help] [--version] --directory DIRECTORY [[--pack TARGET]|[--unpack SOURCE]] [--filename-table] [--naix] [--prefix-header-entries] [--ignore IGNORE_FILE] [--keep KEEP_FILE] [--order ORDER_FILE] [--version-zero] [--verbose]
...
Optional arguments:
  ...
  -d, --directory DIRECTORY  directory to be packed or to dump unpacked files [required]
